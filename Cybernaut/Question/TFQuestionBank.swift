...
class TFQuestionBank {
    ...
    init() {
        ...
        /* Hard T/F questions */
        list.append(TFQuestion(questionText: "Clicking on links in unsolicited emails is safe.", theme: "privacy", correctAnswerText: 0, is_hardness: true))
        ...
        list.append(TFQuestion(questionText: "Providing personal information in response to a text message claiming you've won a prize is safe.", theme: "privacy", correctAnswerText: 0, is_hardness: true))
        ...
        list.append(TFQuestion(questionText: "Granting apps permission to access your location enhances security.", theme: "privacy", correctAnswerText: 0, is_hardness: true))
        list.append(TFQuestion(questionText: "Emails from unrecognized senders requesting sensitive information are trustworthy.", theme: "privacy", correctAnswerText: 0, is_hardness: true))
        ...
        list.append(TFQuestion(questionText: "Sharing passwords via email or text messages is secure.", theme: "privacy", correctAnswerText: 0, is_hardness: true))
        list.append(TFQuestion(questionText: "Opening email attachments from unknown sources is safe.", theme: "privacy", correctAnswerText: 0, is_hardness: true))
        ...
        list.append(TFQuestion(questionText: "Allowing apps to access your contacts enhances privacy.", theme: "privacy", correctAnswerText: 0, is_hardness: true))
